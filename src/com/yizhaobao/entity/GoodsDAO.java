 ...
 * 
 * @see com.yizhaobao.entity.Goods
...
public class GoodsDAO extends HibernateDaoSupport {
	...
	public static final String GOODS_PICTURE = "goodsPicture";
	...
	public static final String GOODS_REPERTORY = "goodsRepertory";
	...
	public List findByGoodsPicture(Object goodsPicture) {
		return findByProperty(GOODS_PICTURE, goodsPicture);
	}
	...
	public List findByGoodsDescribe(Object goodsDescribe) {
		return findByProperty(GOODS_DESCRIBE, goodsDescribe);
	}
	...
	public List findByGoodsRepertory(Object goodsRepertory) {
		return findByProperty(GOODS_REPERTORY, goodsRepertory);
	}
