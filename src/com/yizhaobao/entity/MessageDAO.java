 ...
 * 
 * @see com.yizhaobao.entity.Message
...
public class MessageDAO extends HibernateDaoSupport {
	...
	public static final String PRAISE_NUMBER = "praiseNumber";
	public static final String REVIEW_NUMBER = "reviewNumber";
	...
	public Message findById(java.lang.Integer id) {
		...
		try {
			Message instance = (Message) getHibernateTemplate().get(
					"com.yizhaobao.entity.Message", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByMessageName(Object messageName) {
		return findByProperty(MESSAGE_NAME, messageName);
	}
	...
	public List findByPraiseNumber(Object praiseNumber) {
		return findByProperty(PRAISE_NUMBER, praiseNumber);
	}

	public List findByReviewNumber(Object reviewNumber) {
		return findByProperty(REVIEW_NUMBER, reviewNumber);
	}
