 ...
 * 
 * @see com.yizhaobao.entity.Review
...
public class ReviewDAO extends HibernateDaoSupport {
	...
	public Review findById(java.lang.Integer id) {
		...
		try {
			Review instance = (Review) getHibernateTemplate().get(
					"com.yizhaobao.entity.Review", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByReviewContent(Object reviewContent) {
		return findByProperty(REVIEW_CONTENT, reviewContent);
	}
