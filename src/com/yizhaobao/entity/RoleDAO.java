...
public class RoleDAO extends HibernateDaoSupport {
	...
	public List findByRolePermission(Object rolePermission) {
		return findByProperty(ROLE_PERMISSION, rolePermission);
	}
